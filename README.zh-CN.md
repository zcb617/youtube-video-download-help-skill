...
本工具使用 **PO Token** 绕过 YouTube 的反爬虫验证。**这违反了 YouTube 的服务条款**，并带来以下风险：

- **IP 封禁**：YouTube 可能临时或永久封禁你的 IP 地址
- **账号封禁**：关联的 Google 账号可能被暂停使用
- **法律风险**：大量下载可能导致 DMCA 通知或法律行动
- **违反 ToS**：绕过安全功能违反 [YouTube 服务条款](https://www.youtube.com/t/terms)

**使用本工具即表示你确认：**
1. 你对任何后果承担全部责任
2. 你不会将其用于商业再分发
3. 你理解这是持续的军备竞赛，可能随时失效

**本工具仅供教育/研究目的。使用风险自负。**

详见 [PO Token 风险](#po-token-风险与注意事项) 章节。
